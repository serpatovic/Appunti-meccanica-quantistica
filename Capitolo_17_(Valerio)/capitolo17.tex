...
\begin{center}
\huge{\textbf{\myfont{Armoniche sferiche e Polinomi di Legendre}}} 
\end{center}
\end{tcolorbox}
$\blacksquare$ \textbf{\large{\myfont{Armoniche Sferiche}}}\\
...
$\pmb{\mathtt{Print[{''}Y[0,0]={''}, \quad SphericalHarmonicY[0, 0, \theta, \phi ]]}}$\\
...
$\blacksquare$ \textbf{\large{\myfont{Polinomi associati di Legendre}}}\\
